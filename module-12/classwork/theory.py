...
#     def description (self):
#         return self.description() + ", молоко"
...
#         self.next_heandler = next_handler

#     def handle(self, request):
#         if self.next_heandler:
#             return self.next_heandler.handle(request)
#         return "Unhandled"
...
#     def send(self, message):
#         self.mediator.send(f"{self.name}: {self.message}", self)
...
#     print(f"Email: произошла смена статуса {status}")

# def sms_listener(status):
#     print(f"SMS: произошла смена статуса {status}")
